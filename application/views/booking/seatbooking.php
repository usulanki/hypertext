...
<div class="container-fluid">
    ...
    <div class="row booking_card">
        ...
        <div class="booking-seat-container">
            <div class="col-lg-10 seat-container" todaydate=<?php echo $todayDate; ?>>
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body p-3 p-sm-5" id="results">
                        <div class="row seatrow text-center mx-0">
                            <?php
                            foreach ($floorSeatData as $eachValue) { ?>
                                ...
                                <?php foreach ($eachValue as $eachSeats) {
                                    $bookStatusClass = "seat-available";
                                    $bookedBy = ''; ?>
                                    <?php if (isset($eachSeats['bookings'])) {
                                        $bookStatus = $eachSeats['bookings']['booking_status'];

                                        if ($bookStatus == "1") {
                                            $bookStatusClass = "seat-booked";
                                            $bookedBy = "Booked by " . $eachSeats['bookings']['first_name'];
                                        }
                                        if ($bookStatus == "3") $bookStatusClass = "seat-notavailable";
                                    } ?>
                                    <div>
                                        <div data-toggle="modal" data-target="#exampleModalCenter" tooltip="Seat " placement="top" class="seat-item <?php echo $bookStatusClass; ?> seat_booking" seatid=<?php echo $eachSeats['seat_id'];   ?> title=<?php echo $bookedBy; ?>>
