$(document).ready(function () {
    ...
    $(document).on("click", ".slotstime", function () {
        ...
        let day = $(this).attr('date');
        let slotTime = $(this).attr('shiftid');
        let slotData = $(this).attr('shiftdata');


        $(this).removeClass("slot-available");
        $('.listslots>div.slot-selected').addClass('slot-available');
        $('.listslots>div.slot-selected').removeClass('slot-selected');
    ...
    $(document).on("click", ".seat_booking", function () {
        ...
        var shiftid = document.getElementsByClassName('seat-container')[0].getAttribute("shiftid");
        var shiftdata = document.getElementsByClassName('seat-container')[0].getAttribute("shiftdata");
        $('.booking_row').html('');
